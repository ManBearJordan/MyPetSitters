 ...
 * Restored from V200 to fix Critical Error on Regions Page
 */
...
/**
 * Helper: Get 1st Image URL for Sitter
 */
if (!function_exists('antigravity_v200_get_sitter_thumbnail')) {
function antigravity_v200_get_sitter_thumbnail($post_id, $size = 'large') {
    if (has_post_thumbnail($post_id)) {
...
function antigravity_v200_cities_list() {
    // V200 RESTORATION: Return only Major Cities for Browse Display
    // (Master list 'antigravity_v200_get_valid_locations' is for validation only)
