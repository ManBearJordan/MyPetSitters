...
// Check if mps_services_map exists
if (function_exists('mps_services_map')) {
    echo "Services map: " . print_r(array_keys(mps_services_map()), true);
}

// Check cities
if (function_exists('mps_cities_list')) {
    echo "Cities: " . print_r(mps_cities_list(), true);
}
...
$services = isset($_POST['services']) ? mps_normalise_services_labels($_POST['services']) : [];
...
if (!in_array($city, mps_cities_list())) $errors[] = 'Select a city.';
